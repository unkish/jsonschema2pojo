...
/**
  ...
  * @since 3/17/2017
  */
class ContentResolverNetworkTest {
    ...
    @Test
    void brokenLinkCausesIllegalArgumentException() {
    ...
    @Test
    void serverErrorCausesIllegalArgumentException() {
        URI brokenHttpUri = URI.create("http://" + ADDRESS + ":" + server.getPort() + "/address500.json");
        assertThrows(IllegalArgumentException.class, () -> resolver.resolve(brokenHttpUri));
    }

    @Test
    void httpLinkIsResolvedToContent() {
