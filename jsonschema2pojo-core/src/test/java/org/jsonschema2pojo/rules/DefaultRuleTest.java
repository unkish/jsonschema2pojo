...
class DefaultRuleTest {
    ...
    static Collection<Class<?>> data() {
        return asList(Set.class, List.class);
    }

    @ParameterizedTest
    @MethodSource("data")
    void whenIsInitializeCollections_false_applyDoesNotInitializeField(Class<?> fieldTypeClass) throws JClassAlreadyExistsException {
    ...
    @ParameterizedTest
    @MethodSource("data")
    void whenIsInitializeCollections_true_applyInitializesField(Class<?> fieldTypeClass) throws JClassAlreadyExistsException {
